(function (global, factory) {
	...
	(global = global || self, global.CryptrSpa = factory());
	...
	***************************************************************************** */
	...
	var locationSearch=function(){return null!=window&&void 0!==window.location?window.location.search:""},parseRedirectParams=function(){var e=new URLSearchParams(locationSearch());if(e.get("state")&&e.get("authorization_id")&&e.get("code"))return {state:e.get("state")||"",authorization:{id:e.get("authorization_id")||"",code:e.get("code")||""}};throw new Error("Can not parse authorization params")},CODE_PARAMS=/[?&]code=[^&]+/,STATE_PARAMS=/[?&]state=[^&]+/,AUTH_PARAMS=/[?&]authorization_id=[^&]+/,Client=function(){function e(t){var r,n=this;if(classCallCheck(this,e),defineProperty(this,"config",void 0),defineProperty(this,"memory",new InMemory),defineProperty(this,"worker",void 0),this.configureSentry(t),dist_5(cryptrBaseUrl(t)),dist_1(t.client_id),dist_2(t.default_redirect_uri),t.default_locale&&!ALLOWED_LOCALES.includes(t.default_locale))throw new Error("'".concat(t.default_locale,"' locale not valid, possible values ").concat(ALLOWED_LOCALES));(this.config=t,"serviceWorker"in navigator)&&(this.worker=new WorkerFactory,null===(r=this.worker)||void 0===r||r.addEventListener("message",(function(e){"rotate"==e.data&&n.handleRefreshTokens();})));}var t,r,n,i,a,o,s,c,u,l,h,f,d,g;return createClass(e,[{key:"configureSentry",value:function(e){(void 0===e.telemetry||e.telemetry)&&(init({dsn:"https://4fa5d7f40b554570b64af9c4326b0efb@o468922.ingest.sentry.io/5497495",integrations:[new Integrations.BrowserTracing],tracesSampleRate:1}),setContext("app",{tenant:e.tenant_domain,client_id:e.client_id,audience:e.audience}));}},{key:"getCurrentAccessToken",value:function(){return this.memory.getAccessToken()}},{key:"getCurrentIdToken",value:function(){return this.memory.getIdToken()}},{key:"currentAccessTokenPresent",value:function(){var e=this.getCurrentAccessToken();return void 0!==e&&e.length>0}},{key:"isAuthenticated",value:(g=asyncToGenerator(regenerator.mark((function e(){return regenerator.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.abrupt("return",this.currentAccessTokenPresent());case 1:case"end":return e.stop()}}),e,this)}))),function(){return g.apply(this,arguments)})},{key:"finalScope",value:function(e){if(!e||e===DEFAULT_SCOPE)return DEFAULT_SCOPE;var t=e.split(" "),r=DEFAULT_SCOPE.split(" ");return toConsumableArray(new Set([].concat(toConsumableArray(r),toConsumableArray(t)))).join(" ")}},{key:"signWithoutRedirect",value:(d=asyncToGenerator(regenerator.mark((function e(t){var r,n,i,a=arguments;return regenerator.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return r=a.length>1&&void 0!==a[1]?a[1]:DEFAULT_SCOPE,n=a.length>2?a[2]:void 0,(i=a.length>3&&void 0!==a[3]?a[3]:this.config.default_redirect_uri)!==this.config.default_redirect_uri&&dist_2(i),e.next=6,Transaction.create(t,this.finalScope(r),n,i);case 6:case"end":return e.stop()}}),e,this)}))),function(e){return d.apply(this,arguments)})},{key:"signInWithoutRedirect",value:(f=asyncToGenerator(regenerator.mark((function e(){var t,r,n,i=arguments;return regenerator.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:t=i.length>0&&void 0!==i[0]?i[0]:DEFAULT_SCOPE,r=i.length>1&&void 0!==i[1]?i[1]:this.config.default_redirect_uri,n=i.length>2?i[2]:void 0,this.signWithoutRedirect(Sign.In,t,n,r);case 4:case"end":return e.stop()}}),e,this)}))),function(){return f.apply(this,arguments)})},{key:"signUpWithoutRedirect",value:(h=asyncToGenerator(regenerator.mark((function e(){var t,r,n,i=arguments;return regenerator.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:t=i.length>0&&void 0!==i[0]?i[0]:DEFAULT_SCOPE,r=i.length>1&&void 0!==i[1]?i[1]:this.config.default_redirect_uri,n=i.length>2?i[2]:void 0,this.signWithoutRedirect(Sign.Up,t,n,r);case 4:case"end":return e.stop()}}),e,this)}))),function(){return h.apply(this,arguments)})},{key:"inviteWithoutRedirect",value:(l=asyncToGenerator(regenerator.mark((function e(){var t,r,n,i=arguments;return regenerator.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:t=i.length>0&&void 0!==i[0]?i[0]:DEFAULT_SCOPE,r=i.length>1&&void 0!==i[1]?i[1]:this.config.default_redirect_uri,n=i.length>2?i[2]:void 0,this.signWithoutRedirect(Sign.Invite,t,n,r);case 4:case"end":return e.stop()}}),e,this)}))),function(){return l.apply(this,arguments)})},{key:"signWithRedirect",value:(u=asyncToGenerator(regenerator.mark((function e(t){var r,n,i,a,o,s=arguments;return regenerator.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return r=s.length>1&&void 0!==s[1]?s[1]:DEFAULT_SCOPE,n=s.length>2?s[2]:void 0,(i=s.length>3&&void 0!==s[3]?s[3]:this.config.default_redirect_uri)!==this.config.default_redirect_uri&&dist_2(i),e.next=6,Transaction.create(t,this.finalScope(r),n,i);case 6:return a=e.sent,e.next=9,Transaction.signUrl(this.config,a);case 9:o=e.sent,window.location.assign(o.href);case 11:case"end":return e.stop()}}),e,this)}))),function(e){return u.apply(this,arguments)})},{key:"signInWithRedirect",value:(c=asyncToGenerator(regenerator.mark((function e(){var t,r,n,i=arguments;return regenerator.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:t=i.length>0&&void 0!==i[0]?i[0]:DEFAULT_SCOPE,r=i.length>1&&void 0!==i[1]?i[1]:this.config.default_redirect_uri,n=i.length>2?i[2]:void 0,this.signWithRedirect(Sign.In,t,n,r);case 4:case"end":return e.stop()}}),e,this)}))),function(){return c.apply(this,arguments)})},{key:"signUpWithRedirect",value:(s=asyncToGenerator(regenerator.mark((function e(){var t,r,n,i=arguments;return regenerator.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:t=i.length>0&&void 0!==i[0]?i[0]:DEFAULT_SCOPE,r=i.length>1&&void 0!==i[1]?i[1]:this.config.default_redirect_uri,n=i.length>2?i[2]:void 0,this.signWithRedirect(Sign.Up,t,n,r);case 4:case"end":return e.stop()}}),e,this)}))),function(){return s.apply(this,arguments)})},{key:"inviteWithRedirect",value:(o=asyncToGenerator(regenerator.mark((function e(){var t,r,n,i=arguments;return regenerator.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:t=i.length>0&&void 0!==i[0]?i[0]:DEFAULT_SCOPE,r=i.length>1&&void 0!==i[1]?i[1]:this.config.default_redirect_uri,n=i.length>2?i[2]:void 0,this.signWithRedirect(Sign.Invite,t,n,r);case 4:case"end":return e.stop()}}),e,this)}))),function(){return o.apply(this,arguments)})},{key:"handleInvitationState",value:(a=asyncToGenerator(regenerator.mark((function e(){var t,r,n,i,a,o=arguments;return regenerator.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return t=o.length>0&&void 0!==o[0]?o[0]:DEFAULT_SCOPE,r=new URLSearchParams(locationSearch()),n=r.get("state"),e.next=5,Transaction.createFromState(n,Sign.Invite,t);case 5:return i=e.sent,e.next=8,Transaction.signUrl(this.config,i);case 8:a=e.sent,window.location.assign(a.href);case 10:case"end":return e.stop()}}),e,this)}))),function(){return a.apply(this,arguments)})},{key:"handleRedirectCallback",value:(i=asyncToGenerator(regenerator.mark((function e(){var t,r,n,i;return regenerator.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return t=parseRedirectParams(),e.next=3,Transaction.get(t.state);case 3:return r=e.sent,e.next=6,Transaction.getTokens(this.config,t.authorization,r);case 6:return n=e.sent,this.memory.setAccessToken(n.accessToken),this.memory.setIdToken(n.idToken),n.valid&&(i=Transaction.getRefreshParameters(n),Storage.createCookie(refreshKey(),i),this.recurringRefreshToken(i)),e.abrupt("return",n);case 11:case"end":return e.stop()}}),e,this)}))),function(){return i.apply(this,arguments)})},{key:"canRefresh",value:function(e){var t=new Date;return !this.currentAccessTokenPresent()||e.access_token_expiration_date<t}},{key:"getRefreshStore",value:function(){return Storage.getCookie(refreshKey())}},{key:"handleRefreshTokens",value:(n=asyncToGenerator(regenerator.mark((function e(){var t,r,n;return regenerator.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(null!=(t=this.getRefreshStore())&&t.refresh_token){e.next=3;break}return e.abrupt("return",!1);case 3:if(!this.canRefresh(t)){e.next=14;break}return e.next=6,Transaction.getTokensByRefresh(this.config,t.refresh_token);case 6:r=e.sent,this.memory.setAccessToken(r.accessToken),this.memory.setIdToken(r.idToken),n=Transaction.getRefreshParameters(r),Storage.createCookie(refreshKey(),n),this.recurringRefreshToken(n),e.next=15;break;case 14:this.recurringRefreshToken(t);case 15:return e.abrupt("return",!0);case 16:case"end":return e.stop()}}),e,this)}))),function(){return n.apply(this,arguments)})},{key:"recurringRefreshToken",value:function(e){var t,r={refreshTokenParameters:e};null===(t=this.worker)||void 0===t||t.postMessage(r);}},{key:"getUser",value:function(){var e=this.getCurrentIdToken();return void 0===e?e:Jwt.body(e)}},{key:"getClaimsFromAccess",value:function(e){return void 0!==e&&e.length>0?Jwt.body(e):null}},{key:"hasAuthenticationParams",value:function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:locationSearch();return CODE_PARAMS.test(e)&&STATE_PARAMS.test(e)}},{key:"hasInvitationParams",value:function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:locationSearch();return STATE_PARAMS.test(e)&&!AUTH_PARAMS.test(e)}},{key:"canHandleAuthentication",value:function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:locationSearch();return !this.currentAccessTokenPresent()&&this.hasAuthenticationParams(e)}},{key:"canHandleInvitation",value:function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:locationSearch();return !this.currentAccessTokenPresent()&&this.hasInvitationParams(e)}},{key:"userAccountAccess",value:(r=asyncToGenerator(regenerator.mark((function e(){var t,r,n,i;return regenerator.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(!(t=this.getCurrentAccessToken())){e.next=9;break}return (r=new URL(cryptrBaseUrl(this.config))).pathname="/api/v1/client-management/tenants/".concat(this.config.tenant_domain,"/account-access"),n={client_id:this.config.client_id,access_token:t},i={headers:{Authorization:"Bearer ".concat(t)}},e.abrupt("return",axios$1.post(r.toString(),n,i));case 9:return console.log("no accessToken found"),e.abrupt("return");case 11:case"end":return e.stop()}}),e,this)}))),function(){return r.apply(this,arguments)})},{key:"logOut",value:(t=asyncToGenerator(regenerator.mark((function e(t){var r,n,i=this,a=arguments;return regenerator.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return r=a.length>1&&void 0!==a[1]?a[1]:window.location,(n=this.getCurrentAccessToken())?Request$1.revokeAccessToken(this.config,n).then(function(){var e=asyncToGenerator(regenerator.mark((function e(n){return regenerator.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(void 0===n.data.revoked_at){e.next=8;break}return e.next=3,Storage.clearCookies(i.config.client_id);case 3:return e.next=5,i.memory.clearTokens();case 5:"function"==typeof t&&null!==t?t():(console.info("Default logOut callback : reload page"),void 0!==r&&r.replace(r.href.split("?")[0])),e.next=9;break;case 8:console.error(n.data);case 9:case"end":return e.stop()}}),e)})));return function(t){return e.apply(this,arguments)}}()).catch((function(e){(null==i.config.telemetry||i.config.telemetry)&&captureException(e),console.error(e);})):console.log("No accessToken found"),e.abrupt("return",!0);case 4:case"end":return e.stop()}}),e,this)}))),function(e){return t.apply(this,arguments)})},{key:"decoratedRequest",value:function(e){return Request$1.decoratedRequest(this.getCurrentAccessToken(),e)}}]),e}();
