...
export const environment = {
  ...
  cryptrConfig: {
    ...
    tenant_domain: (process && process.env.CRYPTR_TENANT_DOMAIN) || 'your-tenant-domai',
    ...
    httpInterceptor: {
      apiRequestsToSecure: (process && process.env.CRYPTR_API_TO_SECURE) ? process.env.CRYPTR_API_TO_SECURE.split(',') : ['https://your.backend.api']
    },
